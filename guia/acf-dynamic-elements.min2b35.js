...
function _typeof(t) {
    ...
    var f, u, l, v, h, o = {
        ...
        n = "function" == typeof require ? require : null;
    return v = function (t) {
        var e = new Error("Could not find module '" + t + "'");
        return e.code = "MODULE_NOT_FOUND", e
    }, h = function (t, e, c) {
        var a, l;
        if ("function" == typeof t[e + c]) return e + c;
        for (a = 0; l = o[c][a]; ++a)
            if ("function" == typeof t[e + l]) return e + l;
        return null
    }, f = function (t, e, c, a, l, o) {
        var i, r, s, n, d, p;
        for ("." !== (i = (c = c.split("/")).pop()) && ".." !== i || (c.push(i), i = ""); null != (r = c.shift());)
            if (r && "." !== r && (".." === r ? (t = e.pop(), o = o.slice(0, o.lastIndexOf("/"))) : (e.push(t), t = t[r], o += "/" + r), !t)) throw v(a);
        if (i && "function" != typeof t[i] && ((p = (p = (p = (p = h(t, i, ".js")) || h(t, i, ".json")) || h(t, i, ".css")) || h(t, i, ".html")) ? i = p : 2 !== l && "object" === _typeof(t[i]) && (e.push(t), t = t[i], o += "/" + i, i = "")), !i) return 1 !== l && t[":mainpath:"] ? f(t, e, t[":mainpath:"], a, 1, o) : f(t, e, "index", a, 2, o);
        if (!(d = t[i])) throw v(a);
        return d.hasOwnProperty("module") ? d.module.exports : (s = {}, d.module = n = {
            exports: s,
            id: o + "/" + i
        }, d.call(s, s, n, u(t, e, o)), n.exports)
    }, l = function (t, e, c, a) {
        var l, o = c,
            i = c.charAt(0),
            r = 0;
        if ("/" === i) {
            ...
            if (l = o.split("/", 1)[0], !(t = s[l])) {
                if (n) return n(c);
                throw v(c)
            }
            a = l, e = [], (o = o.slice(l.length + 1)) || (r = (o = t[":mainpath:"]) ? 1 : (o = "index", 2))
        }
        return f(t, e, o, c, r, a)
    }, (u = function (e, c, a) {
        return function (t) {
            return l(e, [].concat(c), t, a)
        }
    })(s, [], "")
}({
    workspace: {
        editor: {
            js: {
                frontend: {
                    modules: {
                        "acf-dynamic-elements.js": function (t, e, c) {
                            void 0 === TCB_Front.js_modules["acf-dynamic-elements"] && TCB_Front.setModuleLoadedStatus("acf-dynamic-elements", !1),
                                function (i, r) {
                                    if (!TCB_Front.isModuleLoaded("acf-dynamic-elements")) {
                                        var d = {
                                            init: function () {
                                                var t = !!tve_frontend_options.is_editor_page;
                                                i("[data-tar-shortcode-attr]").each(function () {
                                                    var t = this.getAttribute("data-tar-shortcode-attr");
                                                    try {
                                                        var e = JSON.parse(t);
                                                        for (var c in e) this.setAttribute(e[c].prop, e[c].value);
                                                        this.removeAttribute("data-tar-shortcode-attr")
                                                    } catch (t) {}
                                                }), d.updateStarRating(t), d.updateProgressBar(t), d.updateFillCounter(t), d.countdownTimer(t), d.hidePlaceholderElements(t), d.updateAnimations(t), d.updateVideos(t), d.lazyLoadPlaceholders(t), d.hideEmptyLinks(t)
                                            },
                                            updateStarRating: function (t) {
                                                i(".tcb-custom-field-source.thrv-rating").each(function () {
                                                    var t = i(this);
                                            ...
                                            getStarHtml: function (t) {
                                                t = t[0];
                                                for (var e = parseFloat(t.dataset.max), c = parseFloat(t.dataset.value) > e ? e : d.getClosestRating(t.dataset.value, e), a = t.dataset.style, l = "", o = this.templates[a].viewbox || "-6 -6 70 70", i = Math.floor(c), r = Math.round(c - i), s = 1; s <= e; s++) {
                                                    var n = "full";
                                                    i < s && s <= i + r ? n = "half" : i + r < s && (n = "empty"), l += '<svg viewBox="' + o + '" class="">' + d.templates[a][n] + "</svg>"
                                                }
                                                return l
                                            },
                                            ...
                                            updateProgressBar: function (e) {
                                                i(".tcb-custom-field-source .tve_progress_bar_fill_wrapper").each(function () {
                                                    var t = i(this);
                                            ...
                                            updateFillCounter: function (c) {
                                                i(".tcb-custom-field-source .tve_fill_counter_n").each(function () {
                                                    var t = i(this),
                                                        e = t.find(".tve_fill_text");
                                                    d.applyFill(t, t[0].dataset.fill, c), e.find(".tve-fill-text-dynamic").length && e.html('<div class="tve-fill-text-dynamic" '.concat(c ? ' contenteditable="false"' : "", ">").concat(t[0].dataset.fill, "%</div>"))
                                                })
                                            },
                                            applyFill: function (t, e, c) {
                                                var a = Number(e),
                                                    l = t.find(".tve_fill_counter_circle circle").attr("r"),
                                                    o = Math.PI * (2 * l);
                                                t.attr("data-fill", a), a < 0 && (a = 0), 100 < a && (a = 100);
                                                var i = a / 100 * o;
                                                c && !t.attr("data-post-list") ? (t.css({
                                                    "stroke-dasharray": ""
                                                }), t.head_css({
                                            ...
                                            countdownTimer: function (e) {
                                                i(".tcb-custom-field-source.thrv_countdown_timer").each(function () {
                                                    e && TVE.Components.countdown_old.compute_time_until(i(this), this.dataset.date, this.dataset.hour, this.dataset.min, !1)
                                                }), i(".tcb-custom-field-source.tve-countdown").each(function () {
                                                    var t = i(this);
                                                    e ? TVE.Components.countdown.updateElement(t) : this.classList.contains("expired") && (t.removeClass("expired").removeData("tcb.countdown"), new TCB_Front.Countdown(t, !1))
                                                })
                                            },
                                            hidePlaceholderElements: function (t) {
                                                if (!t) {
                                                    var c = i(".tcb-custom-field-source");
                                                    i(".dynamic-source").filter("[data-c-f-hidden=1]").closest(".tcb-video-background-parent").hide(), c.filter("[data-c-f-hidden=1]").hide(), [".tve_progress_bar_fill_wrapper", ".tve_fill_counter_n", "iframe"].forEach(function (t) {
                                                        c.find(t).filter("[data-c-f-hidden=1]").hide()
                                                    }), i.each({
                                                        ".tcb-responsive-video": ".thrv_responsive_video",
                                                        audio: ".thrv_audio",
                                                        img: ".tve_image_caption"
                                                    }, function (e, t) {
                                                        c.filter(t).each(function () {
                                                            var t = i(this);
                                            ...
                                            updateAnimationElement: function (t, e) {
                                                var c = i(t);
                                                c.find(e).attr("data-tcb-events", c.attr("data-tcb-events")), c.attr("data-tcb-events", ""), tve_frontend_options.is_editor_page || TCB_Front.event_triggers(c)
                                            },
                                            updateAnimations: function (t) {
                                                var c = i(".tcb-custom-field-source"),
                                                    e = i(".tcb-dynamic-field-source"),
                                                    a = this;
                                                i.each({
                                            ...
                                            videoRegex: function (t, e) {
                                                ...
                                                switch (e) {
                                                    case "youtube":
                                                        (c = !!t.match(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|(youtube-nocookie|youtube)\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/) && RegExp.$1) || (c = !!t.match(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|(youtube-nocookie|youtube)\.com\/(?:embed\/|list\/|playlist\?list=|playlist\?.+&list=))((\w|-){34})(?:\S+)?$/) && RegExp.$1, a = !0);
                                                        break;
                                                    case "vimeo":
                                                        c = t.match(/(http|https)?:\/\/(www\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|)(\d+)(?:|\/\?)/) ? RegExp.$4 : !!t.match(new RegExp("https?://(.+)?player.vimeo.com/video/(.+?)\\?")) && RegExp.$2;
                                                        break;
                                                    case "wistia":
                                                        c = t.match(new RegExp("https?://(.+)?(wistia.com|wi.st)/(medias|embed)/(.+)")) ? RegExp.$4 : !!t.match(new RegExp("https?://(.+)?fast.wistia.net/embed/(.+?)/(.+)")) && RegExp.$3;
                                                        break;
                                                    case "vooplayer":
                                                        c = !!t.match(new RegExp("https?://(.+).(cdn.(vooplayer|spotlightr).com)/(publish|watch)/(.+)")) && RegExp.$5
                                                }
                                                return {
                                                    url: t,
                                                    id: c,
                                            ...
                                            queryString: function (t, e) {
                                                ...
                                                switch (e) {
                                                    case "youtube":
                                                        a += (c = ["rel=" + (t.attr("data-rel") || "1"), "modestbranding=" + (t.attr("data-modestbranding") || "0"), "controls=" + (t.attr("data-controls") || "1"), "showinfo=" + (t.attr("data-showinfo") || "1"), "fs=" + (t.attr("data-fs") || "1"), "wmode=transparent"]).join("&");
                                                        break;
                                                    case "wistia":
                                                        c = ["chromeless=false", "controlsVisibleOnLoad=" + ("0" !== t.attr("data-onload-controls")), "playbar=" + ("0" !== t.attr("data-play-bar")), "fullscreenButton=" + ("0" !== t.attr("data-fs")), "playerColor=" + (t.attr("data-video-color") || "fff"), "videoFoam=true"], "popover" === t.attr("data-embed_type") ? (c.push("popover=true popoverAnimateThumbnail=true"), a += c.join(" ")) : a += c.join("&");
                                                        break;
                                                    case "vimeo":
                                                        a += (c = ["portrait=" + (t.attr("data-modestbranding") || "1"), "title=" + (t.attr("data-showinfo") || "1"), "color=" + (t.attr("data-video-color") || "fff"), "byline=" + (t.attr("data-byline") || "1"), "autopause=0"]).join("&");
                                                        break;
                                                    case "external":
                                                    case "custom":
                                            ...
                                            getEmbedCode: function (t, e, c, a) {
                                                var l = t.id && l ? l : a.find(".tcb-responsive-video").attr("data-code");
                                                switch (c) {
                                                    case "external":
                                                    ...
                                                    case "youtube":
                                                        var o = "1" === a.attr("data-no-cookie") ? "youtube-nocookie" : "youtube";
                                                        return t.isPlaylist ? '<iframe title="Responsive Video" class="tcb-responsive-video" data-code="'.concat(l, '" data-provider="').concat(c, '" src="https://www.youtube.com/embed?listType=playlist&list=').concat(l + e, '" data-src="https://www.').concat(o, ".com/embed?listType=playlist&list=").concat(l + e, '" frameborder="0" allowfullscreen></iframe>') : '<iframe title="Responsive Video" class="tcb-responsive-video" data-code="'.concat(l, '" data-provider="').concat(c, '" src="https://www.youtube.com/embed/').concat(l + e, '" data-src="https://www.').concat(o, ".com/embed/").concat(l + e, '" frameborder="0" allowfullscreen></iframe>');
                                                    case "vimeo":
                                                        return '<iframe title="Responsive Video" class="tcb-responsive-video" data-code="'.concat(l, '" data-provider="').concat(c, '" src="https://player.vimeo.com/video/').concat(l + e, '" data-src="https://player.vimeo.com/video/').concat(l + e, '" frameborder="0" allowfullscreen></iframe>');
                                                    case "wistia":
                                                        return '<iframe title="Responsive Video" class="tcb-responsive-video" data-code="'.concat(l, '" data-provider="').concat(c, '" src="https://fast.wistia.net/embed/iframe/').concat(l + e, '" data-src="https://fast.wistia.net/embed/iframe/').concat(l + e, '" frameborder="0" allowfullscreen></iframe>');
                                                    case "vooplayer":
                                                        return '<iframe title="Responsive Video" allow="autoplay" data-code="'.concat(l, '" data-provider="').concat(c, '" class="tcb-responsive-video video-player-container vooplayer" data-playerId="').concat(l, '" url-params="" allowtransparency="true"  name="vooplayerframe" frameborder="0" allowfullscreen="true" scrolling="no" src="" style="max-width: 100%; position:relative; opacity: 1; min-width: 100%; height:100% !important; width: auto; top: auto;"> </iframe>')
                                                }
                                            },
...
})("workspace/editor/js/frontend/modules/acf-dynamic-elements");